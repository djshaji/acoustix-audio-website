...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>Acoustix Audio Engineering</title>
...
<nav class="navbar navbar-expand-md bg-dark sticky-top border-bottom" data-bs-theme="dark">
  <div class="container">
    <a class="navbar-brand d-md-none logo" href="#">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav flex-grow-1 justify-content-between">
          <li class="nav-item"><a class="logo bold nav-link" href="/">
            <!-- <svg class="bi" width="24" height="24"><use xlink:href="#aperture"/></svg> -->
             <i class="fa-solid fa-heart-pulse me-2"></i>
             Acoustix Audio 
          </a></li>
          <li class="nav-item"><a class="nav-link" href="https://github.com/djshaji">
            <i class="me-2 fa-brands fa-github"></i> Source Code
          </a></li>
